DataCrea = {
  ...
  centurion_sphere_bbot6 = true,
  centurion_shock_baladas = true,
  centurion_spider_tga2 = true,
  bonewalker_weak = true,
  bm_spriggan_co4 = true,
  ash_ghoul_mulyn = true,
  ascended_sleeper = true,
  ["ogrim titan_velas"] = true,
  ["golden saint_velas1"] = true,
  dremora_gothren_guard1 = true,
  gateway_haunt = true,
  centurion_steam_c_l = true,
  corprus_stalker_danar = true,
  rat_diseased = true,
  corprus_lame_morvayn = true,
  fabricant_verminous = true,
  draugr_valbrandr = true,
  ash_ghoul_fgr = true,
  shalk_diseased_hram = true,
  kagouti_blighted = true,
  scrib = true,
  centurion_steam_bbot2 = true,
  centurion_sphere_nchur = true,
  kagouti_hrk = true,
  daedroth_baladas = true,
  shalk = true,
  bm_spriggan_co3 = true,
  centurion_steam_a_c = true,
  heart_akulakhan = true,
  atronach_frost_bm = true,
  centurion_steam_bbot4 = true,
  bm_spriggan_co1 = true,
  lich_relvel = true,
  rat_plague_hall1a = true,
  rat_cave_hhte2 = true,
  ["scrib blighted"] = true,
  centurion_spider_bbot1 = true,
  ["skeleton nord "] = true,
  ...
  bm_skeleton_pirate_capt = true,
  centurion_spider = true,
  rat_pack_rerlas = true,
  hunger_audenian = true,
  bm_bear_black = true,
  bm_sk_champ_bloodskal02 = true,
  atronach_frost = true,
  ...
  draugr_co_3 = true,
  hunger = true,
  centurion_spider_tga1 = true,
  rat_cave_fgrh = true,
  bm_frost_boar = true,
  centurion_projectile_c = true,
  bm_riekling_mounted = true,
  bm_riekling = true,
  bm_bear_brown = true,
  bm_spriggan_co2 = true,
  ...
  goblin_warchief2 = true,
  ancestor_ghost_greater = true,
  rat = true,
  centurion_steam_advance = true,
  ...
  centurion_sphere_bbot5 = true,
  dremora_gothren_guard2 = true,
  ["bm_skeleton_pirate "] = true,
  ash_ghoul = true,
  dremora = true,
  goblin_grunt = true,
  centurion_sphere_hts2 = true,
  ...
  centurion_spider_bbot7 = true,
  centurion_spider_nchur = true,
  bm_horker = true,
  shalk_blighted = true,
  rat_rerlas = true,
  ancestor_ghost = true,
  centurion_projectile = true,
  dreugh_koal = true,
  ["ogrim titan"] = true,
  atronach_flame = true,
  bm_draugr_bloodskal = true,
  ["kwama forager_tb"] = true,
  durzog_war_trained = true,
  ["worm lord"] = true,
  centurion_steam_exhibit = true,
  rat_cave_hhte1 = true,
  ...
  centurion_spider_bbot3 = true,
  bm_sk_champ_bloodskal01 = true,
  ["scrib diseased"] = true,
